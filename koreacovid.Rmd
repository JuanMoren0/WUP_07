...
From looking at all the data we can see that being a male and catching covid will increase the likely hood of dying then if a person was a female, that is shown in both frequency and percentage wise.